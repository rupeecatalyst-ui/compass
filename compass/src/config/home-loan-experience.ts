export const homeLoanExperience = {
  ...
  bestMatch: {
    ...
    headline: "How lender matching works.",
    subheadline: "Illustrative only — your personalised matches appear after analysis in the journey.",
    matches: [
      {
        id: "best",
        tier: "Illustrative Match",
        lender: "Example Lender A",
        rate: "8.35%",
