    ...
    pillars: [
      {
        id: "confidence",
        title: "Confidence",
        description: "Know where you stand before you commit. Walk into every conversation prepared.",
      },
      {
        id: "transparency",
        title: "Transparency",
        description: "Clear explanations of trade-offs, terms, and what truly moves your outcome.",
      },
      {
        id: "decisions",
        title: "Informed decisions",
        description: "Guidance that respects your goals — so you choose with clarity, not noise.",
      },
    ],
  },
  sarathi: {
    ...
    description:
      "Sarathi helps you understand recommendations and make better financial decisions — coaching with clarity, never complexity.",
    cta: "Meet Sarathi",
