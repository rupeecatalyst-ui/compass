      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
          ...
          >
            ...
            <motion.div variants={staggerItem} className="space-y-2">
              <h1 className="text-[2rem] font-bold tracking-tight leading-[1.15] sm:text-5xl lg:text-6xl xl:text-[3.75rem] xl:leading-[1.08]">
                <span className="block text-gradient-subtle">
                  {hero.headlineLine2 ?? "Borrow Better. Invest Smarter."}
                </span>
                {hero.headlineAccent ? (
            ...
            >
              COMPASS is your calm guide for better borrowing and investing decisions — with
            ...
            >
              ...
              <Button
                ...
                asChild
              >
                <Link href={ROUTES.LOAN_PRODUCTS}>View Loan Products</Link>
              </Button>
            </motion.div>
          </motion.div>
