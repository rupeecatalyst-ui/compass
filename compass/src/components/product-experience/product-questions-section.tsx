...
export function ProductQuestionsSection({ landing }: ProductQuestionsSectionProps) {
  const { questions } = landing;
  const [openId, setOpenId] = useState<string | null>(null);

  return (
    <SectionReveal id="product-questions" spacing="related" className="relative">
