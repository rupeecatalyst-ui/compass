export const ROUTES = {
  ...
  ORGANIZATION_PRODUCT_CONFIGURATION: "/organization/product-configuration",
  ORGANIZATION_COMPASS_ADVANTAGE: "/organization/product-configuration/compass-advantage",
...
export const PROTECTED_ROUTES = [
  ...
  ROUTES.ORGANIZATION_PRODUCT_CONFIGURATION,
  ROUTES.ORGANIZATION_COMPASS_ADVANTAGE,
