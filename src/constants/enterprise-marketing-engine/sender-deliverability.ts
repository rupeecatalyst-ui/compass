...
export const MARKETING_SENDER_LIVE_NOT_VERIFIED = "SENDER_LIVE_NOT_VERIFIED" as const;
export const MARKETING_SENDER_AWAITING_PROVIDER_VERIFICATION =
  "AWAITING_PROVIDER_VERIFICATION" as const;
