...
export const ECG_FRAMEWORK_VERSION = "12.1.0";
...
export const ECG_DOMAIN_CATALOGUE: EcgDomainSeed[] = [
  ...
  },
  {
    ...
    name: "CHANAKYA",
    description:
      "Advisory insight rules, Greeting Library, and Closed Loop Business Coaching — structured responses for learning, advisory only (no autonomous automation).",
    engineKey: "chanakya",
  },
  {
...
export const ECG_ENGINE_CATALOGUE: EcgEngineSeed[] = [
  ...
  { engineKey: "chanakya", engineName: "CHANAKYA Advisory", frameworkVersion: "11.2.0", domainKey: "chanakya" },
