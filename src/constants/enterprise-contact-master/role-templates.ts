    ...
    fields: [
      {
        ...
        helpText:
          "Enterprise Lender Registry (active lenders). Org path: Institution → Region → City → Branch.",
      },
      {
        key: "region",
        label: "Region",
        ...
        dataClass: "role",
        owner: "Banker Role",
        why: "Mandatory org region under Institution (Enterprise Region Master).",
        helpText: "Enterprise Region Master — North · South · East · West. Required before City.",
      },
      {
        key: "city",
        label: "City",
        control: "master",
        masterDomain: "city",
        parentFieldKey: "region",
        mandatory: true,
        sortOrder: 3,
        visible: true,
        dataClass: "role",
        owner: "Banker Role",
        why: "Banker operating city — filtered by selected Region (and lender coverage when available).",
        helpText: "Cities filtered by Region. Lender coverage preferred when available.",
      },
      {
        key: "branch",
        label: "Branch",
        ...
        dataClass: "role",
        owner: "Banker Role",
        why: "Branch affiliation — filtered by City (and Region / Institution).",
        helpText: "Branch Master — filtered by Institution → Region → City.",
      },
      {
        key: "designation",
        label: "Designation",
