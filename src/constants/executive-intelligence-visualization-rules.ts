...
export const EI_VISUALIZATION_RULES = [
  ...
  { businessQuestion: "Source Mix", visualization: "Doughnut", kind: "doughnut" },
  { businessQuestion: "Stage Distribution", visualization: "Doughnut", kind: "doughnut" },
  { businessQuestion: "Task Analytics", visualization: "Pie Chart", kind: "pie" },
  { businessQuestion: "Lender Distribution", visualization: "Horizontal Bar", kind: "horizontal_bar" },
  { businessQuestion: "Opportunity Ageing", visualization: "Stacked Bar", kind: "stacked_bar" },
  { businessQuestion: "Disbursement Analytics", visualization: "Bar Chart", kind: "category_bar" },
