...
export const UGJ_JOURNEY_CATALOGUE: readonly UgjJourneyDefinition[] = [
  ...
  },
  {
    ...
    enabled: true,
    sortOrder: 2,
    workspaceTarget: ROUTES.LOAN_JOURNEY,
    workspaceTargetLabel: "Loan Journey",
    supportsAutoSave: true,
    steps: scaffoldSteps("Loan Journey", "Deal Workspace"),
    consumerHints: ["loan-journey", "deals", "my-deals"],
  },
  {
    id: "ugj-investment",
