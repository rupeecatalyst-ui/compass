  ...
  const sections: ChanakyaCreditProposalSection[] = [
    section(
      ...
      [
        ...
        line("Programme", ctx.programmeCitation?.programmeCode),
        line("Programme version", ctx.programmeCitation ? String(ctx.programmeCitation.programmeVersion) : null),
        line("Applicable ROI / range", ctx.programmeCitation?.roiRange),
        line("Eligibility basis", ctx.programmeCitation?.eligibilityBasis),
        line("Required documents", ctx.programmeCitation?.requiredDocuments.join(", ") || null),
        line("Programme effective date", ctx.programmeCitation?.effectiveFrom),
        ``,
