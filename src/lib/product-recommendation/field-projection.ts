...
const RECOMMENDATION_FIELD_BINDINGS: Record<string, FieldBindingOverlay> = {
  ...
  "derived:foirPercent": {
    ...
    aliases: ["foirFit"],
    evaluatorType: RECOMMENDATION_EVALUATOR_TYPES.FOIR_LOWER_BETTER_BANDS,
    scoreability: "fully_scorable",
    notes: "HOME_LOAN / HOME_LOAN_BT V1. Lower FOIR is better. Programme FOIR norm is not this Match % curve.",
  },
  "derived:ltvPercent": {
    programmeFactRef: "ppo:maxLtvExact",
    aliases: ["ltvFit"],
    evaluatorType: RECOMMENDATION_EVALUATOR_TYPES.LTV_LOWER_BETTER_BANDS,
    scoreability: "fully_scorable",
    notes: "HOME_LOAN / HOME_LOAN_BT V1. Assessed LTV = tentative amount ÷ property value. Does not replace programme/RBI caps.",
  },
  ...
  "derived:applicableRoiPercent": {
    ...
    evaluatorType: RECOMMENDATION_EVALUATOR_TYPES.ROI_BPS_FROM_BEST,
    scoreability: "fully_scorable",
    notes: "HOME_LOAN / HOME_LOAN_BT V1. Lower ROI is better. Anchor is the lowest comparable eligible ROI for the run.",
  },
