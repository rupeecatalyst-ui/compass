  ...
  return (
    <div className="h-full min-h-0 overflow-y-auto">
      ...
      <section className="flex min-h-[calc(100vh-3.5rem)] flex-col gap-3 p-3 md:p-4">
        ...
        <div className="grid min-h-0 flex-1 gap-3 lg:grid-cols-[minmax(280px,420px)_minmax(300px,1fr)]">
          <section className="rounded-lg border border-zinc-700 bg-zinc-950/60 p-3">
            ...
            />
            <div className="mt-2 rounded-md border border-zinc-700/80 bg-zinc-900/30 px-3 py-2 text-[12px]">
