...
import { Plus, Search, Settings2, SlidersHorizontal } from "lucide-react";
...
export function LoanBoardToolbar() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5 border-b border-border pb-1 shrink-0">
