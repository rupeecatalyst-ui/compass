...
/**
 * Permanent Business Journey progress visualisation (not a menu).
 * Complements Chanakya Guide — Chanakya explains; this strip shows position.
 */
export function BusinessJourneyNavigator({
  ...
  return (
    ...
    >
      <div className="overflow-x-auto px-3 py-2.5 sm:px-5 scrollbar-thin">
                      ...
                      return (
                        <div key={stage.id} className="flex items-center">
                          <div
                            ...
                            className={cn(
                              "group flex w-[4.75rem] flex-col items-center gap-1 rounded-xl border px-1.5 py-1.5 transition-transform duration-300 sm:w-[5.25rem]",
                              status === "completed" && tone.completed,
                              status === "current" &&
                                cn(tone.current, "bjn-pulse"),
                          ...
                          >
                            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-black/10 text-[9px] font-bold tabular-nums dark:bg-white/15">
                              {status === "completed" ? (
                            ...
                            <span className="line-clamp-2 text-center text-[9px] font-semibold leading-tight tracking-tight">
                              {stage.name}
                              {status === "current" ? (
                                <span className="mt-0.5 block text-[7px] font-medium uppercase tracking-wider opacity-90">
                                  Current
                                </span>
                              ) : null}
                            </span>
