...
import {
  ProductLibraryPrismaEmptyState,
  ProductLibrarySsotCallout,
} from "@/components/catalyst-one/product-library/product-library-ssot-callout";
...
export function ProductRegistryView() {
  ...
  const registry = useMemo(
    () => (prismaMode ? [] : searchProductRegistry(query)),
    [query, prismaMode],
  );
