...
import { PRODUCT_LIBRARY_ICON } from "@/config/product-library-navigation";
...
interface ProductLibraryCommandBarProps {
  title: string;
  description?: string;
  showSearch?: boolean;
  searchValue?: string;
...
export function ProductLibraryCommandBar({
  title,
  description,
  showSearch,
  searchValue = "",
  onSearchChange,
  searchPlaceholder = "Search products, categories, owners...",
  actions,
}: ProductLibraryCommandBarProps) {
  const Icon = PRODUCT_LIBRARY_ICON;

  return (
    <CatalystCommandBar aria-label="Product Library command bar">
      <CommandBarHeader>
        <CommandBarHeaderRow>
          <CommandBarIdentity>
            <CommandBarEyebrow>Admin Console · Product Library</CommandBarEyebrow>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <StatusPill variant="info">Metadata · PCE</StatusPill>
            </div>
          </CommandBarIdentity>
          <CommandBarActions>
