...
import type { CreateWealthPartnerNetworkMemberInput } from "@/types/enterprise-wealth-partner-registry";
...
export async function POST(request: Request, ctx: Ctx) {
  try {
    ...
    const body = (await request.json()) as Omit<
      ...
      "createdBy"
    >;
    const created = await wealthPartnerRegistryService.addNetworkMember(partnerId, {
      ...body,
