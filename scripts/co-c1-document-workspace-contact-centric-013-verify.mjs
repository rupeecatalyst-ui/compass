...
mustContain(workspace, "DOCUMENT_WORKSPACE_DESK_SHEET_CLASSNAME", "canonical right-side desk width");
mustContain("src/constants/document-workspace-refinement-014.ts", "min-[1280px]:min-w-[50vw]", "desktop 50-60vw desk");
mustNotContain(workspace, "fixed inset-0 z-40", "unconditional full-screen desk removed");
