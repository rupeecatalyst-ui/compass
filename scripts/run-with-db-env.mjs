/**
 * Secure runner for CO-ARCH-003 Phase 2A backfill.
 * Injects only DATABASE_URL + DIRECT_URL; never prints values.
 */
...
const script = process.argv[2] || "scripts/co-arch-003-p2a-backfill.mjs";
console.log(`Running ${script} (credential values suppressed)…`);
