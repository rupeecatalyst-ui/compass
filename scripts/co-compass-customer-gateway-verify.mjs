...
assert.match(advantageService, /resolveCompassAdvantageForOpportunity/);
...
assert.match(journeyService, /resolveRelatedCompany/);
assert.match(journeyService, /COMPASS_WEBSITE_SOURCE_CODE|website_compass/);
